...
(function ($) {
  ...
  $('input[name="theme_color"]').on("click", function () {
    ...
    if (isDark === "theme-dark") {
      $(".app-logo").attr(
        "src",
        logoSrc?.split("dark")[0] + "dark/" + $(this).attr("appLogo")
      );
    } else {
      $(".app-logo").attr(
        "src",
        logoSrc?.split("light")[0] + "light/" + $(this).attr("appLogo")
      );
    }
    ...
    if (themeOptionItemValue != "" && themeOptionItemValue != 1) {
      ...
      if (themeOptionItem == "themeColor") {
        ...
        if (isDark === "theme-dark") {
          $(".app-logo").attr(
            "src",
            logoSrc?.split("dark")[0] + "dark/" + themeOptionItemValue
          );
        } else {
          $(".app-logo").attr(
            "src",
            logoSrc?.split("light")[0] + "light/" + themeOptionItemValue
          );
        }
