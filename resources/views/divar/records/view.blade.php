    ...
    <div class="page-content space-top p-b80">
        <div class="container">
            ...
            <div class="fine-card">
                ...
                @if ($record->response['data']['totalAmount'] != 0)
                    <div class="item">
                    ...
                    <div class="item">
                        ...
                        <strong class="price">{{ number_format($record->response['data']['totalAmount']) }}
                            ریال</strong>
                    </div>
                @else
                ...
                <div class="item">
                    ...
                    <strong> {{ verta($record->created_at) }}</strong>
                </div>
                {{-- <div class="item">
                ...
                @if ($record->response['data']['totalAmount'] != 0)
                    <div class="card-body">
                        ...
                        <a href=" {{ route('records.details', $record->endpoint) }}"> <button type="button"
                                class="btn mb-2 me-2 btn-block btn-success">مشاهده جزئیات</button></a>
