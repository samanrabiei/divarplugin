                ...
                <div class="fine-card">
                    ...
                    @if ($messages['response_body']['data']['inquire_price'] != 0)
                        ...
                        <div class="item">
                            <span>شناسه قبض:</span>
                            <div class="copy-box">
                                <strong id="paperId">{{ $messages['response_body']['data']['paper_id'] }}</strong>
                        ...
                        <div class="item">
                            ...
                            <div class="copy-box">
                                <strong id="paymentId">{{ $messages['response_body']['data']['payment_id'] }}</strong>
                        ...
                        <div class="item">
                            ...
                            <strong class="price">{{ number_format($messages['response_body']['data']['inquire_price']) }}
                                ریال</strong>
                        </div>
                    @else
                    ...
                    <div class="item">
                        ...
                        <strong>{{ $messages['response_body']['data']['ejr_inquire_no'] }}</strong>
                    </div>
                </div>
            @else
            @endif
